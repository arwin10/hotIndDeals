            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td><span id="sprytextfield1">
                  <label>
                  <input type="text" name="txtUserName" id="txtUserName" maxlength="50" required />
                  </label>
              ...
              <tr>
                ...
                <td><span id="sprytextfield2">
                  <label>
                  <input type="password" name="txtPassword" id="txtPassword" maxlength="50" required />
                  </label>
                  <span class="textfieldRequiredMsg">A value is required.</span></span></td>
              </tr>
			  
			   <td height="34">UserType:</td>
                <td><span id="sprytextfield2">
                  <select id="txtUsrType" name="txtUsrType">
