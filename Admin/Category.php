            ...
            <table width="100%"  border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td><span id="sprytextfield1">
                  <label>
                  <input type="text" name="txtName" id="txtName" minlength="5" maxlength="30" required />
                  </label>
              ...
              <tr>
                ...
                <td><span id="sprytextarea1">
                  <label>
                  <textarea name="txtDesc" id="txtDesc" cols="35" rows="3" minlength="10" maxlength="1000" required ></textarea>
                  </label>
