          ...
          <table width="100%" height="181" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><span id="sprytextarea1">
                <label>
                <textarea name="txtDetail" id="txtDetail" cols="45" rows="3"  maxlength="200" required ></textarea>
                </label>
            ...
            <tr>
              ...
              <td><span id="sprytextfield2">
                <label>
                <input type="text" name="txtDate" id="txtDate"  onclick="ds_sh(this);" required />
                </label>
                <span class="textfieldRequiredMsg">A value is required.</span></span></td>
            </tr>
            <tr>
