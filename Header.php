					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://www.facebook.com/arwin10"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://twitter.com/Arindam_Hacks"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://plus.google.com/100427282166273553081"><i class="fa fa-google-plus"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.php"><img src="images/home/logo (2).png" alt="" /></a>
						</div>
